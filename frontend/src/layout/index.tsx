...
import {SettingOutlined, FileSearchOutlined, HomeOutlined, UserOutlined, RobotOutlined} from '@ant-design/icons';
...
const LayoutContainer = () => {
  ...
  <Sider collapsible theme="light" style={{ height: "100vh" }}>
    ...
    <Menu theme="light" mode="inline" defaultSelectedKeys={['0']}>
      ...
      <Menu.Item icon={<RobotOutlined  />} key="2">
        <Link to="/AIgame">游戏中心</Link>
      </Menu.Item>
      {/* 动态渲染菜单 */}
